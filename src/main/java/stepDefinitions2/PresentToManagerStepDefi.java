...
import Excel.lib.util.Xls_DataReader;
...
public class PresentToManagerStepDefi {
    ...
    Xls_DataReader readers = new Xls_DataReader(
            "/Users/vedant.jagani/git/Salesforce/CucumberBDDFrame/SampleData/ExcelTestData.xlsx");

    String Receptionist = readers.getCellData("PresentToManager", "Receptionist", 2);
    String CustomerDescription = readers.getCellData("PresentToManager", "CustomerDescription", 2);
    String Email = readers.getCellData("PresentToManager", "Email", 2);
    String Phone = readers.getCellData("PresentToManager", "Phone", 2);
    String FirstName = readers.getCellData("PresentToManager", "FirstName", 2);
    String LastName = readers.getCellData("PresentToManager", "LastName", 2);
    String ZipCode = readers.getCellData("PresentToManager", "ZipCode", 2);
    String StreetAddress = readers.getCellData("PresentToManager", "StreetAddress", 2);
    String GoodSameClubNumber = readers.getCellData("PresentToManager", "GoodSameClubNumber", 2);
    String DealerSalesSearch = readers.getCellData("PresentToManager", "DealerSalesSearch", 2);
    String NotesInputfield1 = readers.getCellData("PresentToManager", "NotesInputfield1", 2);
    String NotesHowWillyouPurchase = readers.getCellData("PresentToManager", "NotesHowWillyouPurchase", 2);
    String NotesTradeIn = readers.getCellData("PresentToManager", "NotesTradeIn", 2);
